...
import terminalImg from '../../assets/images/projects/voidpad/terminal.png';
...
This project documents the process of bringing an old laptop back to life, transforming it into a minimalist writing machine dedicated to personal journaling. The goal is to create a distraction-free environment for capturing thoughts, ideas, and daily reflections. The final setup is shown in [Figure 1](#figure-1).

<figure id="figure-1">
  <Image src={desktopImg} alt="XFCE Desktop Setup" width={1280} height={720} />
  <figcaption>Figure 1: XFCE Desktop Setup</figcaption>
</figure>
...
- Storage upgrade from HDD to SSD
- Battery replacement or removal for desktop use
- Cleaning and CPU thermal paste replacement (see [Figure 2](#figure-2) for thermal improvements)
...
- **Xbps Package Manager**: The xbps package manager is fast, simple, and efficient, making it easy to install only what's needed without unnecessary bloat. The package manager in action is shown in [Figure 10](#figure-10).
...
The successful installation of Void Linux is shown in [Figure 2](#figure-2), displaying the system information via Fastfetch.

<figure id="figure-2">
  <Image src={terminalImg} alt="Void Linux Fastfetch System Information" width={1280} height={720} />
  <figcaption>Figure 2: Void Linux Fastfetch System Information</figcaption>
</figure>
...
The XFCE desktop is configured with a retro aesthetic for a nostalgic writing experience using the [Chicago95](https://github.com/grassmunk/Chicago95) theme, a comprehensive Windows 95-inspired theme for XFCE. The theme has been customized to match personal preferences while maintaining that authentic retro computing feel:
...
The retro-themed XFCE desktop with the customized Chicago95 theme is shown in [Figure 3](#figure-3).

<figure id="figure-3">
  <Image src={desktop2Img} alt="XFCE Desktop Setup with Chicago Theme Modified" width={1280} height={720} />
  <figcaption>Figure 3: XFCE Desktop Setup with Chicago Theme Modified</figcaption>
</figure>
...
Obsidian configured with a retro theme for bidirectional writing is shown in [Figure 4](#figure-4).

<figure id="figure-4">
  <Image src={obsidianImg} alt="Obsidian with retro theme configured for bidirectional writing" width={1280} height={720} />
  <figcaption>Figure 4: Obsidian with retro theme configured for bidirectional writing</figcaption>
</figure>
...
LazyVim configured for coding and editing config files is shown in [Figure 5](#figure-5).

<figure id="figure-5">
  <Image src={neovimImg} alt="LazyVim configured for coding and editing config files" width={1280} height={720} />
  <figcaption>Figure 5: LazyVim configured for coding and editing config files</figcaption>
</figure>
...
Emacs used for experimenting with org mode is shown in [Figure 6](#figure-6).

<figure id="figure-6">
  <Image src={emacsImg} alt="Emacs used for experimenting with org mode" width={1280} height={720} />
  <figcaption>Figure 6: Emacs used for experimenting with org mode</figcaption>
</figure>
### 4. neovim-obsidian
...
After testing all options, **Obsidian** was selected as the primary note-taking application for the Voidpad project (see [Figure 4](#figure-4) for the configured interface).
...
The following gallery showcases various aspects of the Voidpad in use, from leisure activities to system maintenance.

<figure id="figure-7">
  <Image src={oldGamesImg} alt="Retro gaming setup with classic games running on the Voidpad" width={1280} height={720} />
  <figcaption>Figure 7: Taking a break from writing with some nostalgic retro gaming</figcaption>
</figure>

<figure id="figure-8">
  <Image src={screensaverImg} alt="Classic xscreensaver running retro screensaver animations" width={1280} height={720} />
  <figcaption>Figure 8: Can't resist these sweet sweet retro screensavers in xscreensaver</figcaption>
</figure>

<figure id="figure-9">
  <Image src={thermalsImg} alt="System thermal monitoring using bottom process monitor" width={1280} height={720} />
  <figcaption>Figure 9: Keeping an eye on system thermals and performance using bottom - a modern system monitor</figcaption>
</figure>

<figure id="figure-10">
  <Image src={upateImg} alt="XBPS package manager updating system packages" width={1280} height={720} />
  <figcaption>Figure 10: It's a real pleasure to work with xbps package manager! Fast, smooth, and well designed. Sorry pacman!</figcaption>
</figure>

<figure id="figure-11">
  <Image src={webBImg} alt="Retro-themed web browser with classic interface styling" width={1280} height={720} />
  <figcaption>Figure 11: When the Voidpad goes online, browsing the web in style with a retro-themed browser</figcaption>
</figure>
