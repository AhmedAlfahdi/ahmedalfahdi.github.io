...
A bit of TLC goes a long way! Upgraded RAM (6GB → 8GB), swapped the HDD for an SSD, replaced thermal paste, and gave it a thorough cleaning. The hardware can now handle development tasks like a champ.
...
Added a local 3B parameter language model for offline writing assistance. It runs on CPU, keeps everything private, and integrates seamlessly with Obsidian. No cloud, no subscriptions, no data leaving the device.
