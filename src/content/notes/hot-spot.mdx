...
> [!SeeAlso]
> [JWL Equation of State](/engineering/jwl)
...
- **$\mu$**: Hot spot death rate = 5 $\mu s^{-1}$
- **$v$**: Burn velocity (pressure-dependent, from strand burner experiments)
- **$D$**: Potential hot spot death rate = 11.3
- **$\rho_{p0}$**: Initial potential hot spot density = $1.4 \times 10^{10}$ $cm^{-3}$
- **$\epsilon$**: Initial hot spot diameter = $1.5 \times 10^{-4}$ cm (1.5 $\mu m$)


## Burn Rate Functions

Two experimental burn rate regimes are implemented. Low-pressure strand burner data shows burn rates from $1.016 \times 10^{-7}$ cm/$\mu s$ at 0.0001 GPa to $4.441 \times 10^{-3}$ cm/$\mu s$ at 1 GPa. High-pressure diamond anvil cell (DAC) measurements yield much faster rates: $2.35 \times 10^{-7}$ cm/s at 0.0001 GPa up to 0.9852 cm/s at 200 GPa.
...
- Decreasing hot spot density by 10× ($\rho_p = 1.4 \times 10^9$ $cm^{-3}$) reduced fraction reacted to 0.0523 after 4.09 $\mu s$
- Increasing density 10× ($\rho_p = 1.4 \times 10^{11}$ $cm^{-3}$) achieved 0.976 fraction reacted in just 0.114 $\mu s$
