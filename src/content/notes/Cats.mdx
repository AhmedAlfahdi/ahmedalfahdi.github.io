...
//     subgraph SG1["Early Feliform Evolution"]




//     A["66-33 Ma: Miacoids"] --> B("Progenitors of modern carnivorans")
//     B --> C["~40 Ma: Nimravids - False Sabertooth Cats<br/>appear in North America"]
//     C --> D["~30 Ma: Proailurus - First True Cat<br/>appears"]
//     end

//     subgraph SG2["The Cat Gap in North America"]
//     D --> E{"25 Ma - 18.5 Ma:<br/>The Cat Gap"}
//     E --> F["Nimravids extinct in N. America<br/>after 26 Ma"]
//     F --> G["Few cat or cat-like fossils<br/>found in N. America"]
//     G --> H["Possible causes: Hypercarnivory,<br/>global cooling, loss of forests,<br/>volcanic activity"]
//     G -->|Ecological Niche| I["Caniforms evolve hypercarnivorous traits<br/>disputed"]
//     E --> J["18.5 Ma: Pseudaelurus arrives<br/>in N. America via Bering land bridge<br/>from Asia"]
//     end

//     subgraph SG3["Post-Gap and Domestication"]
//     J --> K["All modern-day felids<br/>descend from Pseudaelurus"]
//     K --> L["~10,000 Years Ago:<br/>Domestication begins with farming"]
//     L --> M["Cats attracted to human settlements<br/>by grain stores, hunt rodents"]
//     M --> N["Ancient societies held cats<br/>in high esteem - e.g. Egyptians"]
//     N --> O["Modern Cats:<br/>Highly social, form emotional bonds"]
//     O --> P("Future: Cats served by AGI/Robots<br/>after human extinction")
//     end
//   `}
// />